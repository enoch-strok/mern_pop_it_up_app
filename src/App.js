...
function App() {
  return (
    <div className="App">
      ...
      <LightSwitch firstName={"Jane"} lastName={"Doe"} age={45} hairColor={"Black"}/>
      <LightSwitch firstName={"Millard"} lastName={"Fillmore"} age={50} hairColor={"Brown"}/>
      <LightSwitch firstName={"Maria"} lastName={"Smith"} age={62} hairColor={"Brown"}/>
